...
ALTER TABLE "receipt" ADD COLUMN "total" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "receipt" ADD COLUMN "date" double precision NOT NULL;--> statement-breakpoint
ALTER TABLE "receipt" ADD COLUMN "currency" varchar(10) NOT NULL;--> statement-breakpoint
ALTER TABLE "receipt" ADD COLUMN "store_name" varchar;--> statement-breakpoint
